-- Health center: distinguish full admissions from brief observations (logged + checked out immediately).
...
COMMENT ON COLUMN public.health_center_admissions.visit_type IS
  'admission = camper/staff stays in health center until checkout; observation = brief visit logged to history only';

-- Observations should not trigger admit/checkout notification emails.
