-- Allow any user who has the Incidents page in role_permissions (or any camp role) to
-- create incident reports and link children they can access. Fixes RLS errors on web + mobile.
...
-- Ensure every camp role can reach the Incidents page (matches sidebar defaults).
