...
-- Add unique constraint to evaluation_responses to allow upsert
ALTER TABLE public.evaluation_responses
ADD CONSTRAINT evaluation_responses_evaluation_id_question_id_key UNIQUE (evaluation_id, question_id);
