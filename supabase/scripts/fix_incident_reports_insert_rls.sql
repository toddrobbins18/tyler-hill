-- Run in Supabase SQL Editor to fix "can't add incident report" (RLS blocking INSERT).
-- Safe to re-run. Same as migration 20260628120000_fix_incident_reports_insert_rls.sql
