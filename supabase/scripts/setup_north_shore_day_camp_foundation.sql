-- Run in Supabase SQL Editor (same as migration 20260731120000_north_shore_day_camp_foundation.sql)
...
-- Verify
SELECT id, name, slug, camp_type, is_active
FROM public.companies
WHERE slug = 'north-shore-day-camp';

SELECT d.name, d.is_active, d.sort_order
