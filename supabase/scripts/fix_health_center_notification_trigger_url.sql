-- Re-runnable: point health_center_notification trigger at this project's edge functions.
-- Run in Supabase SQL Editor if Nest admits don't appear in send-health-center-notification logs.
