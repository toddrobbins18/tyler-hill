...
import { CloudRain, Upload, Eye, Trash2 } from "lucide-react";
...
export default function RainyDaySchedule() {
  ...
  const [documents, setDocuments] = useState<RainyDayDocument[]>([]);
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      toast.success("Rainy Day Schedule uploaded successfully");
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Upload and view rainy day schedules</p>
      </div>

      <Card className="p-6">
        <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
          <Upload className="h-5 w-5" />
          Upload Rainy Day Schedule
        </h2>
